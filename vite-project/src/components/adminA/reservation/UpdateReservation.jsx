...
const UpdateReservation = () => {
    ...
    useEffect(() => {
        ...
        axiosClient.get('/reservation-edit/' + id).then(res => {
    ...
    const reservationSubmit = (e) => {
        ...
        const datas = reservationInput

        axiosClient.put('/reservation-update/' + id, datas).then(res => {
        ...
        <div className='container' style={{ display: 'flex', justifyContent: 'center' }} >
            <div className='card col-lg-9 mt-5'>
                <div className='card-header text-center'>
                    <h4 className='display-7'>Edit Reservation N° {id}</h4>
                </div>
