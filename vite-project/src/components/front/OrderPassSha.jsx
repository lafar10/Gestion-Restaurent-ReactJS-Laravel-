            ...
            <div className='container mt-5 '>
                ...
                <div className='card mt-5'>
                    ...
                    <div className='card-body'>
                        <h1 className='display-6 text-center' style={{ fontSize: 29 }}>Small : 15 DH's  |  Medium : 40 DH's  |  Large : 60 DH's</h1>
...
{/*                                 <input type='hidden' name='meal_price' onChange={handleInput} value={ordersInput.meal_price} className='form-control' />
